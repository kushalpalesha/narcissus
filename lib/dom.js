/**
 * Most of the dom function implementations are adapted from dom.js found at:
 * https://github.com/andreasgal/dom.js.git
 */
...
function createHTMLDocument(titleText) {
  var address = null;
  var d = new Document(true, address);
